    ...
    <Route path='/' element={<RootLayout />}>
      ...
      >
        <Route
          ...
          element={<UsersPage />}
          handle={{
            crumb: () => <Link to="/dashboard/users">Usuarios</Link>
          }}
        />
        ...
        <Route
          ...
          handle={{
            crumb: (data) => <Link to="/dashboard/users">Usuarios / {data.id}</Link>
          }}
        />
        ...
        <Route
          ...
          handle={{
            crumb: () => <Link to="/dashboard/services">Servicios</Link>
          }}
        />
        ...
        <Route
          ...
          handle={{
            crumb: (data) => <Link to="/dashboard/services">Servicios / {data.id}</Link>
          }}
        />
        ...
        <Route
          ...
          handle={{
            crumb: () => <Link to="/dashboard/appointments">Citas</Link>
          }}
        />
        ...
        <Route
          ...
          handle={{
            crumb: (data) => {
              return <Link to="/dashboard/appointments">Citas / {data.id}</Link>
            }
          }}
        />
