...
export default function MyAppointmentsEditPage() {
  ...
  if (!appointment) return <h5 className='font-medium text-2xl text-center text-gray-800'>No se encontró la cita.</h5>
