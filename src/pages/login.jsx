    ...
    >
      ...
      <main className='flex flex-col gap-4'>
        <div className='w-full flex flex-col gap-2'>
          ...
          {formErrors.email && <p className='text-red-500 text-sm'>Hubo un error con el correo.</p>}
        </div>
        ...
        <div className='w-full flex flex-col gap-2'>
          ...
          {formErrors.password && <p className='text-red-500 text-sm'>Hubo un error con la contraseña, ingrese la contraseña correcta.</p>}
        </div>
      </main>
